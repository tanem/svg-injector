...
suite('SVGInjector', () => {
  ...
  // See: https://github.com/tanem/svg-injector/issues/1192.
  test('handles Document wrangling via old libs', (done) => {
    const orglDocument = window.Document
